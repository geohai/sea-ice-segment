...
from models_dual_early import DeepLabLikeMultiStreamDict
...
def main(config):
    ...
    for dir_idx, dir_out in enumerate(dir_outs):
        ...
        test_rasters_1 = test_rasters_1_all[dir_idx*2:dir_idx*2+2]
        test_rasters_2 = test_rasters_2_all[dir_idx*2:dir_idx*2+2]
        test_label_rasters = test_label_rasters_all[dir_idx*2:dir_idx*2+2]

        max_len = max(len(test_rasters_1), len(test_rasters_2))

        for idx in range(max_len):

            test_raster_1 = test_rasters_1[idx]
            test_raster_2 = test_rasters_2[idx]
